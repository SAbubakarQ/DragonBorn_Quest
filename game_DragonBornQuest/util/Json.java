package game_DragonBornQuest.util;// ----------------------------------------------------------------
...
//     Submarine(game_DragonBornQuest.util.Json ob)
//     {
...
//         game_DragonBornQuest.util.Json tmpList = ob.get("ammo");
...
//     game_DragonBornQuest.util.Json marshal()
//     {
//         game_DragonBornQuest.util.Json ob = game_DragonBornQuest.util.Json.newObject();
//         ob.add("atomic", atomic);
//         ob.add("crewSize", crewSize);
//         ob.add("depth", depth);
//         ob.add("peri", peri.marshal());
//         game_DragonBornQuest.util.Json tmpList = game_DragonBornQuest.util.Json.newList();
//         ob.add("ammo", tmpList);
//         for(int i = 0; i < ammo.size(); i++)
//             tmpList.add(ammo.get(i).marshal());
                // bricks.add(new game_DragonBornQuest.sprites.Brick(temp.get(i)));
//         return ob;
//     }
// }
//
